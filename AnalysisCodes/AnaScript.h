...
public :
  ...
  /*TTreeReaderArray<UChar_t> Electron_genPartIdx =               {fReader, "Electron_genPartIdx"};
  ...
  /*TTreeReaderArray<UChar_t> Muon_genPartIdx =       {fReader, "Muon_genPartIdx"};
  ...
  /*TTreeReaderArray<UChar_t> Tau_genPartIdx =               {fReader, "Tau_genPartIdx"};
  ...
  /*TTreeReaderArray<Float_t> GenJet_partonFlavour =      {fReader_MC, "GenJet_partonFlavour"};
    TTreeReaderArray<Float_t> GenJet_hadronFlavour =      {fReader_MC, "GenJet_hadronFlavour"};*/
  ...
  float TriggEff2016preVFPData_IsoMu24( float pt, float eta);
  float TriggEff2016postVFPMC_IsoMu24( float pt, float eta);
  float TriggEff2016postVFPData_IsoMu24( float pt, float eta);
  ...
  float TriggEff2016preVFPData_Ele27_WPTight_Gsf( float pt, float eta);
  float TriggEff2016postVFPMC_Ele27_WPTight_Gsf( float pt, float eta);
  float TriggEff2016postVFPData_Ele27_WPTight_Gsf( float pt, float eta);
  float TriggEff2017MC_Ele32_WPTight_Gsf( float pt, float eta);
  float TriggEff2017Data_Ele32_WPTight_Gsf( float pt, float eta);
  float TriggEff2018MC_Ele32_WPTight_Gsf( float pt, float eta);
  float TriggEff2018Data_Ele32_WPTight_Gsf( float pt, float eta);
...
public:
  ...
  //Boson Pt SF
  double ZpTFactor_DY(int MCSample, TLorentzVector v1, TLorentzVector v2);
  double JetReWeighting_DY(int MCSample, vector<Particle>Jets);
...
private:
  ...
  vector<float> MassArray_4L, MassArray_2LOS, MassArray_2e2mu, MassArray_chosen, MassArray_unchosen;

  vector<Particle> pairing1, pairing2, pairing3;
  vector<Particle> genMuon, genElectron, genZ, genLightLepton, genVLLDoublet, genVLLNuDoublet, genJets;
  vector<Particle> Muon, Electron, LightLepton, Photon, Tau, Jets, bJets, looseMuon, looseEle, loosellep, loosetau;
