...
private:
  ...
  bool is_l2_event, is_l2SS_event, is_l3_event, is_l4_event, is_l12j_event;
  ...
  vector<float> MassArray_4L, MassArray_2e2mu, MassArray_chosen, MassArray_unchosen;
  ...
  vector<Particle> Muon, Electron, LightLepton, Photon, Tau, Jets, bJets, loosellep, loosetau, looseMuon;
