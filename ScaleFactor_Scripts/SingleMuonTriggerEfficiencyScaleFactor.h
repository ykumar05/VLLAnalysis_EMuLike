 ...
 *                                  2016preVFP                                   *
 *********************************************************************************/
float AnaScript::TriggEff2016preVFPMC_IsoMu24( float pt, float eta){
...
float AnaScript::TriggEff2016preVFPData_IsoMu24( float pt, float eta)
{
  if( pt<10 || eta>2.4 ) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
 ...
 *                                  2016postVFP                                  *
 *********************************************************************************/
float AnaScript::TriggEff2016postMC_IsoMu24( float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
...
float AnaScript::TriggEff2016postVFPData_IsoMu24( float pt, float eta)
{
  if( pt<10 || eta>2.4 ) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
 ...
 *                                    2017                                       *
 *********************************************************************************/
float AnaScript::TriggEff2017MC_IsoMu27( float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
...
float AnaScript::TriggEff2017Data_IsoMu27( float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
    if(pt<=100)
 ...
 *                                    2018                                       *
 *********************************************************************************/
float AnaScript::TriggEff2018MC_IsoMu24( float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
...
float AnaScript::TriggEff2018Data_IsoMu24( float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
